...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.button_restart.grid(row=0, column=3, padx=10, pady=10)
        ...
        weights = [1, 1, 1,1]  # For example, three rows with different weights
        ...
        weights = [2, 1, 1,1,1]  # Total weight = 6
        ...
        batch_size_label = ttk.Label(config_frameG2, style="Custom.TLabel",text="BATCH_SIZE : "+consts.BATCH_SIZE)
        batch_size_label.grid(row=0, column=0, padx=5, pady=5, sticky="w")
        ...
        #NUM_EPOCHS
        num_epochs_label_D = ttk.Label(config_frameG2, style="Custom.TLabel",text="NUM_EPOCHS : "+consts.NUM_EPOCHS)
        ...
        # LEARNINGN RATE
        LR_Label_D = ttk.Label(config_frameG2, style="Custom.TLabel",text="LEARNINGN RATE : ")
        ...
        IMAGES_SIZE_D = ttk.Label(config_frameG2, style="Custom.TLabel",text="TRAINIG_INPUT_SIZE : "+sizeInput+' x '+sizeInput)
        ...
        # DATASET GOOD
        DATASET_GOOD = ttk.Label(config_frameG2, style="Custom.TLabel",text=" DATASET PATH  : ")
        ...
        checkpoints_D = ttk.Label(config_frameG2, style="Custom.TLabel",text="CHECKPOINTS: ")
        ...
        exp_D = ttk.Label(config_frameG2, style="Custom.TLabel",text="ACTUAL EXPERIMENT NUMBER  : ")
        ...
        config_frameG2.grid(row=1, column=4, columnspan=3, sticky="nw", padx=10, pady=10)
        ...
        check_button = customtkinter.CTkButton(config_frame4, font=custom_font,text="Start test all images", command=self.start_test_All)
