...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        config_frame5 = ttk.LabelFrame(tab2,style="Custom.TLabelframe",text="THRESHOLD  ")
        
        # THRESHOLD_label = ttk.Label(config_frame5, style="Custom.TLabel",text="THRUSHOLD ")
        ...
        # 
        # 
        #  Image and prediction----------------,font=("Arial", 12, "bold")
        fixed_size = (512, 512)  
        ...
        inImageTest2=consts.IMAGE_prediction_PATH#,font=("Arial", 12, "bold")
        self.prediction_label = ttk.Label(tab2, font=custom_font,text="Prediction", compound="bottom",foreground="white", background=background_color)
        self.prediction_label.grid(row=5, column=4, padx=0, pady=10, sticky="nsew")
        image = Image.open(inImageTest2)  # Replace with your image path
        image = image.resize(fixed_size, Image.LANCZOS)
        photo = ImageTk.PhotoImage(image)
        # Set the image in the label
        self.prediction_label.config(image=photo)
        self.prediction_label.image = photo
    ...
    def initialisation_folder(self):
        ...
        self.update_constant_file('IMAGE_prediction_PATH',os.path.join(self.current_dir, "waiting_1.png"))
    ...
    def start_training(self):
        ...
        process = subprocess.Popen([
                "python",
                "C:/Users/wjdgu/OneDrive/Desktop/project/2024-1/capstone_design/main_test_all_v2.py",
                "--train"
            ])
    ...
    def updateImages(self):
        ...
        inImageTest2=consts.IMAGE_prediction_PATH
...
#calc threshold
    ...
    def check_result(self):
        ...
        if consts.PREDECTION_RESUILT == "good":
            ...
            print('good path', image_path, "exists:", os.path.exists(image_path))
            if os.path.exists(image_path):
                self.update_image(image_path)
            else:
                print("Positive image not found.")

        elif consts.PREDECTION_RESUILT == "bad":
            image_path = os.path.join(self.current_dir, "negative.jpg")
            print('bad path', image_path, "exists:", os.path.exists(image_path))
            if os.path.exists(image_path):
                self.update_image(image_path)
            else:
                print("Negative image not found.")
